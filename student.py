...
class Student:
    def __init__(self, root):
        ...
        # section_entry = ttk.Entry(class_student_frame, textvariable = self.var_section, width=15, font=(
        #     "times new roman", 13))
        ...
        # gender_entry = ttk.Entry(class_student_frame, textvariable = self.var_gender, width=15, font=(
        #     "times new roman", 13))
        ...
        update_photo_btn = Button(btn_frame1, text="Update photo sample", bg="purple", width=33, font=(
            "times new roman", 12), fg="white")
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                # 0 for webcam, 1 for other cameras
                img_id=0
                while(True):
                    ...
                    if face_cropped(myFrame) is not None:
                        ...
                        cv2.putText(face, str(img_id), (50, 50), cv2.FONT_HERSHEY_COMPLEX, 2, (0,255,255), 2)  # Origin:(50,50)
