...
class Login:
    def __init__(self, root):
        ...
        Frame_login.place(x=400, y=100, height=500, width=600)

        # Title & Subtitle
        title = Label(Frame_login, text="Login Here", font=("Impact", 35, "bold"), fg="#d77337", bg="white").place(x=150, y=50)
        desc = Label(Frame_login, text="Attendance System", font=("Goudy old style", 15, "bold"), fg="#d25d17", bg="white").place(x=150, y=150)

        # Username
        lbl_username = Label(Frame_login, text="Username", font=("Goudy old style", 15, "bold"), fg="gray", bg="white").place(x=50, y=220)
        self.txt_username = Entry(Frame_login, font=("times new roman", 15), bg="lightgray", textvariable=self.username)
        self.txt_username.place(x=50, y=250, width=250)

        # Password
        lbl_password = Label(Frame_login, text="Password", font=("Goudy old style", 15, "bold"), fg="gray", bg="white").place(x=50, y=300)
        ...
        # Login Button
        login_btn = Button(Frame_login, text="Login", cursor="hand2", command=self.login, fg="white", bg="#d77337", font=("times new roman", 20)).place(x=150, y=380)
